    ...
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            if (escolha == 1)
            {
                ...
                // Funcao Registra
                metodos.fila.insereAluno(ref ultimo, novoAluno);
                ultimo = novoAluno;
            ...
            else if (escolha == 2)
            {
                ...
                elemento alunoRemovido = metodos.fila.removeAluno(ref ultimo, ref primeiro);
            ...
            {
                Console.Clear();
                metodos.fila.mostrar(ref primeiro, ref ultimo);
