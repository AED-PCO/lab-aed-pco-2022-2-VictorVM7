...
internal class Program
{
        ...
        while (pos >= 0)
        {
            ...
            else if (escolha.Equals("v"))
            {
                if (pos != 0)
                {
                    ...
                    imprimeVetor(pilhaN, pilhaN.Length);
                }
    ...
    static int[] retira(int[] vet, int pos, int[] pilhaN)
    {
        string escolha;
        pilhaN[pos - 1] = vet[pos - 1];
        for (int i = pos; i > 0; i--)
        {
